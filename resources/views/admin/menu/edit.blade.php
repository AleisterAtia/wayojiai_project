...
@section('content')
    <div class="max-w-4xl mx-auto py-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-3xl font-bold text-gray-800">Edit Menu: <span class="text-orange-600">{{ $menu->name }}</span>
            </h2>
        ...
        @if ($errors->any())
            <div class="mb-6 bg-red-50 border-l-4 border-red-500 p-4 rounded shadow-sm">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-red-800">Gagal memperbarui menu:</h3>
                            ...
                            <div>
                                ...
                                <select name="status"
                                    ...
                                    <option value="tersedia"
                                        {{ old('status', $menu->status) == 'tersedia' ? 'selected' : '' }}>✅ Tersedia
                                    </option>
                                    <option value="habis" {{ old('status', $menu->status) == 'habis' ? 'selected' : '' }}>
                                        ❌ Habis</option>
                                </select>
                            </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="4"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition shadow-sm resize-none">{{ old('description', $menu->description) }}</textarea>
                            </div>
                                ...
                                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:bg-gray-50 transition cursor-pointer relative group"
                                    ...
                                    <div class="space-y-1 text-center w-full">
                                        ...
                                        <div
                                            ...
                                            @if ($menu->image)
                                                <img id="imagePreview" src="{{ asset('storage/' . $menu->image) }}"
                                            ...
                                            {{-- Placeholder (Hanya tampil jika tidak ada gambar lama dan belum upload baru) --}}
                                            <div id="uploadPlaceholder"
                                                class="{{ $menu->image ? 'hidden' : 'flex' }} flex-col items-center">
