...
<div x-data="{
createCategoryModal: false, // Ditambahkan untuk modal Create
...
<div class="p-6 bg-white rounded-lg shadow-xl">
    <div class="flex items-center justify-between mb-6">
        ...
        {{-- TOMBOL TAMBAH - DIUBAH DARI <a> KE <button> UNTUK MEMBUKA MODAL --}}
    ...
    @if ($errors->any() && (session()->has('create_error') || session()->has('edit_error')))
                        ...
                        <tr class="hover:bg-orange-50/50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                ...
                                <button @click="
                                    ...
                                    editFormAction = '{{ route('admin.categories.update', $category->id) }}';
                                ...
                                <button @click="
                                    ...
                                    currentCategory.name = '{{ $category->name }}';
                                    deleteFormAction = '{{ route('admin.categories.destroy', $category->id) }}';
        ...
        <div x-transition:enter="ease-out duration-300" 
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="mt-4">
                                <label for="new_name" class="block text-sm font-medium text-gray-700">Nama Kategori</label>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    ...
                    <button @click="createCategoryModal = false" type="button" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                        Batal
                    </button>
                </div>
            </form>
        ...
        <div x-transition:enter="ease-out duration-300" 
            ...
            <form :action="editFormAction" method="POST">
                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-headline">
                                Edit Kategori: <span x-text="currentCategory.name" class="font-bold text-orange-600"></span>
                            </h3>
                            <div class="mt-4">
                                <label for="name_edit" class="block text-sm font-medium text-gray-700">Nama Kategori Baru</label>
                                <input type="text" name="name" id="name_edit" x-model="currentCategory.name" 
                                       required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-orange-500 focus:border-orange-500 sm:text-sm">
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    ...
                    <button @click="editCategoryModal = false" type="button" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                        Batal
                    </button>
                </div>
            </form>
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div x-transition:enter="ease-out duration-300" 
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                Apakah Anda yakin ingin menghapus kategori **<span x-text="currentCategory.name"></span>**? Tindakan ini tidak dapat dibatalkan.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                ...
                <button @click="deleteCategoryModal = false" type="button" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:w-auto sm:text-sm">
                    Batal
                </button>
            </div>
        </div>
